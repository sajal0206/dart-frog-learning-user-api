...
UserWhereInput _$UserWhereInputFromJson(Map<String, dynamic> json) =>
    UserWhereInput(
      ...
      age: json['age'] == null
          ? null
          : IntFilter.fromJson(json['age'] as Map<String, dynamic>),
    );
...
UserOrderByWithRelationInput _$UserOrderByWithRelationInputFromJson(
  Map<String, dynamic> json,
    ...
    UserOrderByWithRelationInput(
      ...
      age: $enumDecodeNullable(_$SortOrderEnumMap, json['age']),
    );
...
Map<String, dynamic> _$UserOrderByWithRelationInputToJson(
  ...
  writeNotNull('age', _$SortOrderEnumMap[instance.age]);
  return val;
}
  ...
  Map<String, dynamic> json,
    ...
    UserScalarWhereWithAggregatesInput(
      AND: (json['AND'] as List<dynamic>?)?.map(
        (e) => UserScalarWhereWithAggregatesInput.fromJson(
