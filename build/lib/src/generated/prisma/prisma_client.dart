// ignore_for_file: no_leading_underscores_for_library_prefixes, public_member_api_docs, non_constant_identifier_names, unnecessary_raw_strings, invalid_use_of_internal_member
...
class UserScalarWhereWithAggregatesInput implements _i1.JsonSerializable {
  ...
  final IntWithAggregatesFilter? age;
...
class UserUpdateInput implements _i1.JsonSerializable {
  ...
  final IntFieldUpdateOperationsInput? age;
...
extension UserModelDelegateExtension on _i1.ModelDelegate<User> {
  ...
  Future<Iterable<UserGroupByOutputType>> groupBy({
    ...
    compiler(Iterable<Map> groupByUser) => groupByUser.map(
          (Map groupByUser) =>
...
class PrismaClient extends _i1.BasePrismaClient<PrismaClient> {
  ...
  factory PrismaClient({
    ...
    final engine = _i5.BinaryEngine(
      logger: logger,
      schema:
          r'',
      datasources: datasources?.toJson().cast() ?? const {},
      executable:
          r'E:\Education\Dart\Frog\tasklist_backend\node_modules\prisma\query-engine-windows.exe',
    );
